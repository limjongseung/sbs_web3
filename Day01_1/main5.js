/* 
    연산자: 측정값을 도출하기 위해 연산을 처리하는 식별자 - 3가지
    ...
    프로그램밍 언어에서 "=" 표시는 같다 라는 게 절대 아니고, 오른쪽의 값을 왼쪽에 대입한다.
...
//대입연산자에서 산술 연산자랑 같이 결합이 되어있는 복합대입연산
let num5 =2;
//num5 = num5 + 2;
num5 += 2;
console.log(num5);
...
let result2 = (2==="2"); //숫자, 문자 자료형까지 체크했을때 값은 같으나, 자료형으로 틀리다.
console.log(result2);

// == 2개는 자료형이 다르더라도 값이 같기 때문에 true를 반환해서 느슨한 비교연산
// ===3개는 값 뿐만 아니라 자료형까지 같아야 true를 반환합니다. 좀더 느슨한 연산이 되겠죠
let num9 = "2";
num9 = num9 +2;
console.log(num9);
//22이라는 결과가 나오는데 문자형과 숫자형이 붙어있는 형태로 나오며 문자형으로 취급된다.
